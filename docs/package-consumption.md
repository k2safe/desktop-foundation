...
```text
https://github.com/k2safe/desktop-foundation/releases/download/v0.1.28/desktop-foundation-bridge-0.1.28.tgz
```
...
```bash
pnpm release:package-manifest -- --tag v0.1.28 --output /tmp/foundation-packages.json
```
