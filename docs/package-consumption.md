...
```text
https://github.com/k2safe/desktop-foundation/releases/download/v0.1.23/desktop-foundation-bridge-0.1.23.tgz
```
...
```bash
pnpm release:package-manifest -- --tag v0.1.23 --output /tmp/foundation-packages.json
```
