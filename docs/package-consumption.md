...
```text
https://github.com/k2safe/desktop-foundation/releases/download/v0.1.33/desktop-foundation-bridge-0.1.33.tgz
```
...
```bash
pnpm release:package-manifest -- --tag v0.1.33 --output /tmp/foundation-packages.json
```
